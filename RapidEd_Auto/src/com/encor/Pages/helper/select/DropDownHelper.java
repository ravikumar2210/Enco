package com.encor.Pages.helper.select;
...
import com.encor.Pages.helper.javaScript.javaScriptHelper;

public class DropDownHelper {

	private WebDriver driver;
	private static final Logger log = Logger.getLogger(DropDownHelper.class.getName());
